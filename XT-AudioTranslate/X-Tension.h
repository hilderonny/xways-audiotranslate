...
typedef void(__stdcall* fptr_XWF_GetVolumeName) (HANDLE hVolume, wchar_t* lpString,	DWORD nType);

// XWF_GetVolumeInformation (tested)
typedef void(__stdcall* fptr_XWF_GetVolumeInformation) (HANDLE hVolume,	LPLONG lpFileSystem, DWORD* nBytesPerSector, DWORD* nSectorsPerCluster,	INT64* nClusterCount, INT64* nFirstClusterSectorNo);

// XWF_GetSectorContents
typedef BOOL(__stdcall* fptr_XWF_GetSectorContents) (HANDLE hVolume, INT64 nSectorNo, wchar_t* lpDescr, LPLONG lpItemID);
...
// XWF_CreateFile
typedef long int(__stdcall* fptr_XWF_CreateFile) (LPWSTR pName, DWORD nCreationFlags, LONG nParentItemID, PVOID pSourceInfo);

// XWF_FindItem1
typedef long int(__stdcall* fptr_XWF_FindItem1) (LONG nParentItemID, LPWSTR lpName,	DWORD nFlags, LONG nSearchStartItemID);
...
// XWF_GetItemOfs
typedef void(__stdcall* fptr_XWF_GetItemOfs) (LONG nItemID, INT64* lpDefOfs, INT64* lpStartSector);

// XWF_SetItemOfs
typedef void(__stdcall* fptr_XWF_SetItemOfs) (LONG nItemID, INT64 nDefOfs, INT64 nStartSector);

// XWF_GetItemInformation
typedef INT64(__stdcall* fptr_XWF_GetItemInformation) (LONG nItemID, LONG nInfoType, LPBOOL lpSuccess);

// XWF_SetItemInformation
typedef BOOL(__stdcall* fptr_XWF_SetItemInformation) (LONG nItemID, LONG nInfoType, INT64 nInfoValue);

// XWF_GetItemType
typedef LONG(__stdcall* fptr_XWF_GetItemType) (LONG nItemID, wchar_t* lpTypeDescr, DWORD nBufferLenAndFlags);

// XWF_SetItemType
typedef void(__stdcall* fptr_XWF_SetItemType) (LONG nItemID, wchar_t* lpTypeDescr, LONG nTypeStatus);
...
typedef LONG(__stdcall* fptr_XWF_GetHashSetAssocs) (LONG nItemID, LPWSTR lpBuffer, LONG nBufferLen);

// XWF_GetReportTableAssocs
typedef LONG(__stdcall* fptr_XWF_GetReportTableAssocs) (LONG nItemID, wchar_t* lpBuffer, LONG nBufferLen);

// XWF_AddToReportTable
typedef LONG(__stdcall* fptr_XWF_AddToReportTable) (LONG nItemID, wchar_t* lpReportTableName, DWORD nFlags);

// XWF_GetComment
typedef wchar_t* (__stdcall* fptr_XWF_GetComment) (LONG nItemID);

// XWF_AddComment (tested)
typedef BOOL(__stdcall* fptr_XWF_AddComment) (LONG nItemID, wchar_t* lpComment,	DWORD nFlagsHowToAdd);

// XWF_OutputMessage (tested)
typedef void(__stdcall* fptr_XWF_OutputMessage) (const wchar_t* lpMessage, DWORD nFlags);

// XWF_GetUserInput
typedef INT64(__stdcall* fptr_XWF_GetUserInput) (LPWSTR lpMessage, LPWSTR lpBuffer,	DWORD nBufferLen, DWORD nFlags);
...
typedef HANDLE(__stdcall* fptr_XWF_CreateEvObj) (DWORD nType, LONG nDiskID,	LPWSTR lpPath, PVOID pReserved);
...
// XWF_CopyToContainer
typedef LONG(__stdcall* fptr_XWF_CopyToContainer) (HANDLE hContainer, HANDLE hItem, DWORD nFlags, DWORD nMode, INT64 nStartOfs,	INT64 nEndOfs, LPVOID pReserved);

// XWF_CloseContainer
typedef LONG(__stdcall* fptr_XWF_CloseContainer) (HANDLE hContainer, LPVOID pReserved);
...
// XWF_GetCaseProp
typedef INT64(__stdcall* fptr_XWF_GetCaseProp) (LPVOID pReserved, LONG nPropType, PVOID pBuffer, LONG nBufLen);
...
// XWF_GetEvObjProp
typedef INT64(__stdcall* fptr_XWF_GetEvObjProp) (HANDLE hEvidence, DWORD nPropType,	PVOID pBuffer);
